...
public class ContratoMaquinas extends Contrato {
    ...
    /**
     * Construtor da classe ContratoMaquinas. Inicializa todos os atributos da classe.
     * 
    ...
    public ContratoMaquinas(Data inicio, Data fim, int numero, Gerente gerente, Maquina maquina,
        ...
        // Chama o construtor da classe pai (Contrato) para inicializar os atributos gerais
    ...
    /**
     * Retorna uma representação em string do contrato da máquina, incluindo detalhes
     * como o nome da máquina, situação, valor mensal, datas, e outras informações.
     * 
