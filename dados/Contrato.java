...
public class Contrato {
	...
	public Contrato(Data inicio, Data fim, int numero, Gerente gerente) {
		...
		if (inicio.comparaData(fim) == 1) {
			// Caso a data de início seja posterior, ajusta a data de fim para ser igual à de início e define a duração como 0.
			this.dataFim = inicio;
     ...
     * @return 1 se a data foi atualizada com sucesso, ou 0 se a atualização não foi realizada.
     */
