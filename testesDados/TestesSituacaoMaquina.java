...
public class TestesSituacaoMaquina {
	   ...
	   @Test
	    void testConstrutorValidoFinanciada() {
	    ...
	    @Test
	    void testConstrutorValidoAlugada() {
	    ...
	    @Test
	    void testConstrutorValidoComprada() {
	    ...
	    @Test
	    void testVerificaSituacaoValida() {
	    ...
	    @Test
	    void testVerificaSituacaoInvalida() {
