...
public class TestesUsuario {
    ...
    @Test
    void testCriaUsuarioComCpfValido() {
    ...
    @Test
    void testCriaUsuarioComCpfInvalido() {
        Data dataNascimento = new Data(12, 12, 1990); // Exemplo de data válida
    ...
    @Test
    void testCodigoDeIdentificacao() {
    ...
    void testCpfVazio() {
        ...
        Usuario usuario = new Usuario("Roberta Almeida", "", "roberta@example.com", 5000.0f, dataNascimento, 303, "senha303");
